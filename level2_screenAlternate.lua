...
local triangleTextCorrect
local triangleTextIncorrect 
	...
	if (shape == "triangle") then
		...
		if (answerBox1Filled == true) and (answerBox2Filled == true) and ( answerBox3Filled == true) then
			if (userAnswer1.text == "I") and (userAnswer2.text == "N") and (userAnswer3.text == "L") then
				triangleTextCorrect.isVisible = true
			else
				triangleTextIncorrect.isVisible = true
			end
		end
...
function scene:create( event )
    ...
    triangleTextIncorrect = display.newText("Try Again", display.contentWidth/2, display.contentHeight/1.5, nil, 100) 
    triangleTextIncorrect.isVisible = false
    triangleTextCorrect = display.newText("Correct", display.contentWidth/2, display.contentHeight/1.5, nil, 100)
	triangleTextCorrect.isVisible = false
	triangleTextCorrect:setTextColor(0/255, 255/255, 0/255)
	triangleTextIncorrect:setTextColor(255/255, 0/255, 0/255)
